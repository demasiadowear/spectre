...
const CHIAVI_AMMESSE: readonly string[] = [
  ...
  "media_displayable_count",
  "social_readiness", "social_confirmed_count", "social_likely_count",
  "social_unverified_count", "social_browser_required_count",
  "social_rejected_count",
  "search_status", "search_queries",
